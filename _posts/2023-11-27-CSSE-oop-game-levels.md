...
<script type="module">
    ...
    */
    ...
    var assets = {
      ...
      jumpPlatforms: {
        brick: {src: "/images/platforms/brick_wall.png"}
      }
      backgrounds: {
    ...
    */
    ...
    // Game screens
    new GameLevel( {tag: "hills", background: assets.backgrounds.hills, platform: assets.platforms.grass, jumpPlatforms: assets.jumpPlatforms.brick, player: assets.players.mario, enemy: assets.enemies.goomba, tube: assets.obstacles.tube, callback: testerCallBack } );
